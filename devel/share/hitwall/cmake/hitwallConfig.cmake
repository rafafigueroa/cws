...
if("TRUE" STREQUAL "TRUE")
  set(hitwall_SOURCE_PREFIX /home/rafa/cws/src/hitwall)
  set(hitwall_DEVEL_PREFIX /home/rafa/cws/devel)
  set(hitwall_INSTALL_PREFIX "")
  set(hitwall_PREFIX ${hitwall_DEVEL_PREFIX})
else()
  set(hitwall_SOURCE_PREFIX "")
  set(hitwall_DEVEL_PREFIX "")
  set(hitwall_INSTALL_PREFIX /home/rafa/cws/install)
...
if(NOT "" STREQUAL "")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      message(FATAL_ERROR "Project 'hitwall' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/rafa/cws/src/hitwall/${idir}'.  Ask the maintainer 'turtlebot <turtlebot@todo.todo>' to fix it.")
    endif()
...
set(depends "roscpp;rospy;std_msgs;message_runtime;geometry_msgs;kobuki_msgs;nav_msgs;sensor_msgs;gazebo_msgs;tf;gazebo_ros")
